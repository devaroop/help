...
PaisaWorks will show you the transactions from this range, plus some extra transactions just for good measure. Select all transactions that appear on your bank statements.
...
* When the amount is below zero, your PaisaWorks asset account has less money in it than your bank says it should have.
* When the amount is more than zero, your PaisaWorks asset account has more money in it than your banks says it should have.
